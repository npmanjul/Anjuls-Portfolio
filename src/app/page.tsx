...
export default function Home() {
  ...
  return (
    <>
      {showLoader ? (
        <div
          className={`h-screen w-full flex items-center justify-center transform transition-all duration-1000 ease-in-out ${
            showLoader
        ...
        <div className="relative flex items-center justify-center h-full lg:h-screen w-full min-h-[100vh] bg-black">
          ...
          <div
            className={`lg:max-w-[1500px] py-5 pb-15 lg:py-15 w-full flex lg:flex-row flex-col items-center lg:items-start justify-start lg:justify-center gap-4 md:gap-6 h-full transform transition-all duration-1000 ease-in-out ${
              !showLoader
          ...
          >
                  ...
                  <div className="flex flex-col items-start justify-center gap-4 py-4">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <div className="flex flex-col items-start justify-center">
                        ...
                        <a
                          href="mailto:anjulsingh462@gmail.com"
                          className="text-neutral-500 text-[14px] hover:text-neutral-300 transition-colors"
                        >
                    ...
                    <div className="flex justify-center items-center gap-5 py-3 w-full">
                      ...
                      <a
                        href="https://www.linkedin.com/in/anjul-singh-3500a1219/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:opacity-80 transition-opacity"
                      >
                      ...
                      <a
                        href="https://www.instagram.com/anjul__s/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:opacity-80 transition-opacity"
                      >
            ...
            {/* Right Part */}
            <div
              className={`relative bg-white/20 backdrop-blur-sm border-2 border-neutral-600 h-auto lg:h-full w-[95%] lg:w-[60%] max-h-[100%]  lg:max-h-[1000px] rounded-3xl overflow-y-auto scrollbar-hide ${
                activeTab === "contact"
                  ? "overflow-y-hidden"
                  : "overflow-y-auto"
              }`}
